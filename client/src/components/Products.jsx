      ...
      <div className="flex flex-wrap items-center justify-center gap-6 rounded-md m-6">
        {
            products.map((item,index)=>(
                <div className="flex flex-col bg-white rounded-md w-[300px] gap-2" key={index}>
                <img src={item.imageUrl} className="h-[300px] sm:h-[400px] overflow-hidden rounded-md" alt="image" />
               <div className="p-2">
